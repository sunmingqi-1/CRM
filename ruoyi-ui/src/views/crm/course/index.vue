  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="是否删除 1 是" prop="isDelete">
          <el-input v-model="form.isDelete" placeholder="请输入是否删除 1 是" />
        </el-form-item>
      </el-form>
...
<script>
import { listCourse, getCourse, delCourse, addCourse, updateCourse } from "@/api/crm/course";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        isDelete: [
          { required: true, message: "是否删除 1 是不能为空", trigger: "blur" }
        ]
      }
    };
  },
